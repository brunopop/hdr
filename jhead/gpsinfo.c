...
void ProcessGpsInfo(unsigned char * DirStart, unsigned char * OffsetBase, unsigned ExifLength)
{
    ...
    strcpy_s(ImageInfo.GpsLat, 31, "? ?");
    strcpy_s(ImageInfo.GpsLong, 31, "? ?");
    ...
    for (de=0;de<NumDirEntries;de++){
        ...
        switch(Tag){
            ...
            case TAG_GPS_LONG:
                ...
                strcpy_s(FmtString, 21, "%0.0fd %0.0fm %0.0fs");
                for (a=0;a<3;a++){
                    int den, digits;
                ...
                sprintf_s(TempString, 50, FmtString, Values[0], Values[1], Values[2]);

                if (Tag == TAG_GPS_LAT){
                    strncpy_s(ImageInfo.GpsLat+2, 29, TempString, 29);
                }else{
                    strncpy_s(ImageInfo.GpsLong+2, 29, TempString, 29);
                }
                break;
            ...
            case TAG_GPS_ALT:
                sprintf_s(ImageInfo.GpsAlt + 1, 19, "%.2fm", 
